  ...
  return (
    <div>
      {/* ⚡ Bolt Performance Optimization:
          Removed manual state-based filtering (searchTerm), custom remove handler, and custom renderOption.
          Using MUI Autocomplete's built-in filterSelectedOptions and default multiple rendering
          for optimized rendering and native selection management */}
      <Autocomplete
        multiple
