...
const Signup = () => {
  ...
  const [farmerIdError, setFarmerIdError] = useState<string>('');
  ...
  const emailCellphoneLabel = () =>
    t('email').concat(' ').concat(t('o')).concat(' ').concat(t('cellphone'));
    ...
    <>
      <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6 rounded-b-lg ">
        ...
        <div className="flex justify-center">
          <button className="btn btn-primary" onClick={() => magicLogin()}>
