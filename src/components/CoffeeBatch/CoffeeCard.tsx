        ...
        <div className="py-8 bg-white overflow-hidden">
          ...
          Lote <p className="font-black">#</p>
                ...
                <span className="font-serif text">
                  <span className="text-black text-6xl text-bold"> {coffeeBatch.cupProfile.note}%
                </span>
                  <br/>
                  Perfil de taza
                  <br/>
                  Peso KG:<p className="font-black b-t"></p>
                            ...
                            <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <p className="">{coffeeBatch.farm.varieties}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <p className="font-black"><>{t("coordinates")}</>
                                        :
                                    </p>
