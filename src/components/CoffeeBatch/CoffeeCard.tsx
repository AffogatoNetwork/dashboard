  ...
  return (
    <>
      ...
      <div className="overflow-hidden bg-white py-8">
        <div className="m-auto px-6 text-gray-600 md:px-12  xl:container xl:px-6">
          <div className="grid gap-8 md:grid-cols-1 lg:grid-cols-2">
            <div className="card row-span-2 rounded-3xl	border-2 border-amber-900 bg-gray-50 p-8 text-center shadow-2xl shadow-gray-600/10">
              <div className="flex h-full flex-col  space-y-2">
                ...
                <figure className="px-10 pt-5">
                  {NFT === 'Proexo' && (
                    <img
                      src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2FNFT%2Fproexo.gif?alt=media&token=b46258aa-7c52-468b-af3d-d3edffe77f49"
                      className="w-32"
                    />
                  )}
                  {NFT === 'Comsa' && (
                    <img
                      src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2FNFT%2Fcomsa.gif?alt=media&token=bba1fd79-c5de-493f-b0ef-b62f9ed2cd4a"
                      className="w-32"
                    />
                  )}
                  {NFT === 'Commovel' && (
                    <img
                      src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2FNFT%2Fcommovel.gif?alt=media&token=90369031-0bf8-499d-9cd2-26a02791dbd8"
                      className="w-32"
                    />
                  )}
                  {NFT === 'Copracnil' && (
                    <img
                      src="https://console.firebase.google.com/u/0/project/affogato-fde9c/storage/affogato-fde9c.appspot.com/files/~2Fassets~2FNFT"
                      className="w-32"
                    />
                  )}
                </figure>
                <div className="text-center">
                  <span className="md:text-xl">
                    <span className="text font-serif">
                      <span className="text-bold text-6xl text-black">
                      ...
                      Perfil de taza
                      <br />
                      Peso KG:<span className="b-t font-black"></span>
                    </span>
                  </span>
                </div>
                <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                  ...
                  <div>
                    ...
                    <span className="">{coffeeBatch?.farm.area}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="">{coffeeBatch?.farm.etnic_group}</span>
                  </div>
                  <div>
                    <h3 className="font-black">
                      <>{t('family-members')}</>
                  ...
                  <div>
                    ...
                    <span className="">{coffeeBatch?.farm.certifications}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="">
              {(!!coffeeBatch?.wetMill.variety ||
                ...
                <div className="card rounded-3xl border-2 border-amber-900 p-8 text-center shadow-2xl shadow-gray-600/10 dark:shadow-none sm:flex sm:space-x-8">
                  <h1 className="pb-2 text-center text-2xl underline decoration-yellow-700 decoration-2">
                    Detalle de lote
                  </h1>
                  <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                    {!!coffeeBatch?.wetMill.variety && (
                      <div>
                        <h3>
                          <>{t('variety')}</>:
                  ...
                  <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                    {!!coffeeBatch?.wetMill.drying_id && (
                      <div>
                        ...
                        <span>{coffeeBatch?.wetMill.drying_id}</span>
                      </div>
                    )}
                    {!!coffeeBatch?.wetMill.entry_id && (
                      <div>
                        ...
                        <span>{coffeeBatch?.wetMill.entry_id}</span>
                      </div>
                    )}
                    {!!coffeeBatch?.wetMill.quality && (
                      <div>
                        ...
                        <span>{coffeeBatch?.wetMill.quality}</span>
                      </div>
                    )}
                    {!!coffeeBatch?.wetMill.process && (
                      <div>
                    ...
                    {!!coffeeBatch?.wetMill.date &&
                      coffeeBatch.wetMill.date !== '1970-01-01' && (
                        <div>
                          ...
                          <span>{coffeeBatch?.wetMill.date}</span>
                        </div>
                      )}
                    {!!coffeeBatch?.wetMill.facility && (
                      <div>
                        ...
                        <span>{coffeeBatch?.wetMill.facility}</span>
                      </div>
                    )}
                    ...
                    {!!coffeeBatch?.wetMill.weight && (
                      <div>
                        <h3>Peso</h3>
                        <span>{coffeeBatch?.wetMill.weight} Quintales</span>
                      </div>
                    )}
                    {!!coffeeBatch?.wetMill.note && (
                      <div>
                  ...
                  <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                    ...
                    {!!coffeeBatch?.dryMill.export_drying_id && (
                      <div>
                        ...
                        <span>{coffeeBatch?.dryMill.export_drying_id}</span>
                      </div>
                    )}
                    {!!coffeeBatch?.dryMill.date &&
                      coffeeBatch.dryMill.date !== '1970-01-01' && (
                        <div>
                          ...
                          <span>{coffeeBatch?.dryMill.date}</span>
                        </div>
                      )}
                    ...
                    {!!coffeeBatch?.dryMill.facility && (
                      <div>
                        ...
                        <span>{coffeeBatch?.dryMill.facility}</span>
                      </div>
                    )}
                    ...
                    {!!coffeeBatch?.dryMill.threshing_process && (
                      <div>
                        ...
                        <span>{coffeeBatch?.dryMill.threshing_process}</span>
                      </div>
                    )}
                    {!!coffeeBatch?.dryMill.threshing_yield && (
                      <div>
                    ...
                    {!!coffeeBatch?.dryMill.weight && (
                      <div>
                        ...
                        <span>{coffeeBatch?.dryMill.weight} Quintales</span>
                      </div>
                    )}
                    {!!coffeeBatch?.dryMill.note && (
                      <div>
                ...
                <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                  {!!coffeeBatch?.roasting.bag_size && (
                    <div>
                      ...
                      <span>{coffeeBatch?.roasting.bag_size} onz</span>
                    </div>
                  )}
                  ...
                  {!!coffeeBatch?.roasting.packaging && (
                    <div>
                      ...
                      <span>{coffeeBatch?.roasting.packaging}</span>
                    </div>
                  )}
                  ...
                  {!!coffeeBatch?.roasting.roast_date && (
                    <div>
                      ...
                      <span>{coffeeBatch?.roasting.roast_date}</span>
                    </div>
                  )}
                  ...
                  {!!coffeeBatch?.roasting.roast_type && (
                    <div>
                      ...
                      <span>{coffeeBatch?.roasting.roast_type}</span>
                    </div>
                  )}
                </div>
              </div>
