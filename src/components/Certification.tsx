...
const Certification = () => {
  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8"></div>
      ...
      {company === 'comsa' && (
        <div className="grid gap-6 row-gap-5 mb-8 lg:grid-cols-5 sm:row-gap-6 sm:grid-cols-2">
          ...
          <div className="relative bg-white overflow-hidden md:h-64 xl:h-80 transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
            <img
      ...
      {company === 'proexo' && (
        <div className="grid gap-6 row-gap-5 mb-8 lg:grid-cols-4 sm:row-gap-6 sm:grid-cols-2">
          ...
          <div className="relative bg-white overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
            <img
              className="object-cover w-full h-56 md:h-64 xl:h-80 "
              src={require('../assets/certificaciones/2_Fair Trade.jpeg')}
              alt=""
            />
            <p className="mb-4 text-lg font-bold text-center">Fair Trade</p>
          </div>
