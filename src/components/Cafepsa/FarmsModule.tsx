...
export const FarmsModule = () => {
  ...
  const [links, setlInks] = useState(
    'https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2FIMG_1718.jpeg?alt=media&token=c37a0d05-a8dc-4cfd-b3c1-fcc0502dcd77',
  );
      ...
      <div className="m-4">
        ...
        <div className="modal modal-bottom sm:modal-middle">
          <div className="modal-box relative">
            ...
            <div className="flex justify-center m-6">
              <div>
                <h1> Latitud :{currentLat}</h1>
                <h1> Longitud :{currentLng}</h1>
                <div className="flex pt-8 space-x-4 place-content-center">
                  <div>
                    <NewMap
                      latitude={currentLat}
