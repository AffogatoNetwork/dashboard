...
export const ComsaLanding = () => {
    ...
    return (<>
        <section>
            ...
            <div id="header" className="hero min-h-screen opacity-95"
      ...
      <a className="text-gray-500 hover:text-blue-500" href="https://www.facebook.com/comsamarcala" rel="noopener noreferrer" target="_blank" >
        ...
        <a className="ml-3 text-gray-500 hover:text-pink-500" href="https://www.instagram.com/comsamarcalaoficial/" rel="noopener noreferrer" target="_blank">
          <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
            ...
            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                                       ...
                                       <a className="ml-3 text-gray-500 hover:text-red-500" href="https://www.youtube.com/c/COMSAMarcalaOficial" rel="noopener noreferrer" target="_blank">
