            ...
            <div className="wrapper mx-auto text-gray-900 font-normal max-w-[1320px]"><a> </a>
                ...
                <div className="px-[12px] md:px-[36px] xl:px-0 mt-[30px] md:mt-[80px] lg:mt-[143px]">
                    ...
                    <div className="flex flex-wrap items-center justify-center mb-[30px] md:mb-[60px] lg:mb-[80px]"><a
                        ...
                        href="https://www.proexo.org/#"><img className="w-44 h-32"
                            src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2Fproexo.png?alt=media&token=d726955b-e0c4-4f2b-b409-1b6472b07019" alt="Proexo" loading="lazy" decoding="async" /></a><a
                                className="transition-all duration-300 partner-item p-[15px] md:pr-[15px] xl:w-auto lg:w-[184px] hover:translate-y-[-3px]"
                                href="https://www.comsa.hn"><img className="w-30 h-32"
                                    src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2Fcomsa.png?alt=media&token=37064738-74d0-4ba7-9363-07e8b382ce43" alt="Comsa" loading="lazy" decoding="async" /></a>
                        <a
                            className="transition-all duration-300 partner-item p-[15px] md:pr-[15px] xl:w-auto lg:w-[184px] hover:translate-y-[-3px]"
                            href=""><img className="w-32 h-32"
                                src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2Fcommovel.png?alt=media&token=dbc7c2b0-406c-49f9-afa5-e7dc160114e3" alt="partner logo" loading="lazy" decoding="async" /></a>
                        <a
                            className="transition-all duration-300 partner-item p-[15px] md:pr-[15px] xl:w-auto lg:w-[184px] hover:translate-y-[-3px]"
                            href="https://montanaverdehn.com"><img className="w-28 h-28"
                                src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2Fcopracnil.png?alt=media&token=64ae7aa5-baea-415a-b0e9-81b4daf3ee17" alt="partner logo" loading="lazy" decoding="async" /></a>
                    </div>
                ...
                >
                    ...
                    <div className="relative flex-1"><img
                        ...
                        src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/Proexo%2F4.jpeg?alt=media&token=376da7da-4bbe-4d43-945e-d8d1574cc222" alt="Agon" loading="lazy" decoding="async" /><img
                            className="h-full w-full object-cover absolute animate-float max-w-[225px] max-h-[230px] rounded-[14px] bottom-[-20px] left-[-10px]"
                            src="https://firebasestorage.googleapis.com/v0/b/affogato-fde9c.appspot.com/o/assets%2FCaptura%20de%20pantalla%202023-04-11%20a%20la(s)%2001.06.45.png?alt=media&token=41144e0a-0d33-47a1-8b8a-5eb5a3062a15" alt="Agon" loading="lazy" decoding="async" />
                    </div>
                </div>
                    ...
                    <div className="px-[12px] md:px-[36px] xl:px-0 mt-[70px]">
                        <div className="flex flex-col items-center gap-2 mb-14 md:flex-row md:justify-between"><img
                            ...
                            <div className="flex items-center flex-col gap-5 md:flex-row lg:gap-[30px]">
                                ...
                                <Link 
                                    to="/signup"
                                    className="btn btn-lg bg-black text-white font-chivo font-bold flex items-center justify-center"
                                >
                                    Crea una Cuenta
                                </Link>
                            </div>
